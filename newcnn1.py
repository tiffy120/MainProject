...
def read_dataset(path):
    data_list = []
    label_list = []
    my_list = os.listdir(r'D:\vehicle classification with deep learning\src\dataset')
    for pa in my_list:

        print(pa,"==================")
        for root, dirs, files in os.walk(r'D:\vehicle classification with deep learning\src\dataset\\' + pa):

         for f in files:
            file_path = os.path.join(r'D:\vehicle classification with deep learning\src\dataset\\'+pa, f)
